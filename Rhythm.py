...
def start(Screen, musicIndex = 1):
    ...
    Effect_1_Left = pygame.image.load("Rhythm/effect/gin_tape_fan_man.png").convert_alpha()
    Effect_1_Left = pygame.transform.scale(Effect_1_Left, (720, 720))

    Effect_1_Right = pygame.image.load("Rhythm/effect/gin_tape_fan_woman.png").convert_alpha()
    ...
    music, SongSection, SongName, SongTime, SpecialTiming = SL.LoadSong(musicIndex)
    ######################################################################
    # 시간 계산
